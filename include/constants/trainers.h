...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_CECI,
    TRAINER_PIC_RAIHAN,
    TRAINER_PIC_SMALLANT,
    TRAINER_PIC_JAIDEN_ANIMATIONS,
    TRAINER_PIC_JOY,
    ...
    TRAINER_PIC_DARUDE,
    TRAINER_PIC_SELAH,
    TRAINER_PIC_BARBADOS_SLIM,
    TRAINER_PIC_LUIGI,
    TRAINER_PIC_JEFFERY,
    TRAINER_PIC_BENDER,
    TRAINER_PIC_BILL_NYE,
    TRAINER_PIC_TUMBLRITA,
    TRAINER_PIC_DYLAN_M,
    TRAINER_PIC_BLOSSOM,
    TRAINER_PIC_KARL_MARX,
    TRAINER_PIC_GOD,
    TRAINER_PIC_JESUS,
    TRAINER_PIC_LEELA,
    TRAINER_PIC_AMY,
    TRAINER_PIC_ZOIDBERG,
    TRAINER_PIC_FARNSWORTH,
    TRAINER_PIC_HERMES,
    TRAINER_PIC_SAVANNA,
    TRAINER_PIC_TEACHER_JOY,
    TRAINER_PIC_TEACHER_STEPHANIE,
    TRAINER_PIC_TEACHER_MELADEE,
    TRAINER_PIC_TEACHER_COLLEEN,
    TRAINER_PIC_BLOND_CHILD_F,
    TRAINER_PIC_BLOND_CHILD_M,
    TRAINER_PIC_BROWNHAIREDCHILDM,
    TRAINER_PIC_BROWNHAIREDCHILDF,
    TRAINER_PIC_BLACKHAIREDCHILDM,
    TRAINER_PIC_BLACKHARIEDCHILDF,
    TRAINER_PIC_YOUR_MOM,
    TRAINER_PIC_BEN_SHAPIRO,
    TRAINER_PIC_KAITILIN_BENNETT,
    TRAINER_PIC_STEVEN_CROWDER,
    TRAINER_PIC_JUMBO_GRUNT_M,
    TRAINER_PIC_JUMBO_GRUNT_F,
    TRAINER_PIC_ASS_GRUNT_M,
    TRAINER_PIC_ASS_GRUNT_F,
    TRAINER_PIC_HEYIMMIGHTY,
    TRAINER_PIC_GEORGE,
    TRAINER_PIC_FLOYD,
    TRAINER_PIC_HARPER,
    TRAINER_PIC_BLUE,
...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_TEAM_JUMBO,
    TRAINER_CLASS_TEAM_ASS,
    TRAINER_CLASS_TEAM_GALACTIC,
    TRAINER_CLASS_JUMBO_ADMIN,
    TRAINER_CLASS_ASS_ADMIN,
    TRAINER_CLASS_GALACTIC_ADMIN,
    TRAINER_CLASS_JUMBO_BOSS,
    TRAINER_CLASS_ASS_BOSS,
    TRAINER_CLASS_GALACTIC_BOSS,
    TRAINER_CLASS_TEACHER,
    TRAINER_CLASS_ELITE_FIVE,
    TRAINER_CLASS_FR_RIVAL,
