...
// NOTE: The defines here are named in order to match Pokémon Showdown's naming conventions. This is done to avoid issues with trainerproc parsing species names. 
//If a Pokémon does not have an entry on Showdown, use your best judgement.
...
enum __attribute__((packed)) Species
{
    ...
    SPECIES_GRASSHOLE = 1573,
    SPECIES_ANALGAE = 1574,
    SPECIES_RECTREEM = 1575,
    SPECIES_FISHNISM = 1576,
    SPECIES_SJWHALE = 1577,
    SPECIES_SHARKY = 1578,
    SPECIES_SHARKEDO = 1579,
    SPECIES_LARVADES = 1580,
    SPECIES_PROBOSKITO = 1581,
    SPECIES_VENOWATT = 1582,
    SPECIES_CURICRAWL = 1583,
    SPECIES_GUTSICOON = 1584,
    SPECIES_GUTSIFLY = 1585,
    SPECIES_KENGEON = 1586,
    SPECIES_FRIEDEN = 1587,
    SPECIES_COROOSTER = 1588,
    SPECIES_LANDSHIT = 1589,
    SPECIES_EARTHCRAP = 1590,
    SPECIES_DIRTWASTE = 1591,
    SPECIES_EJACASM = 1592,
    SPECIES_HOSAJACK = 1593,
    SPECIES_CONDOOM = 1594,
    SPECIES_ARABOMB = 1595,
    SPECIES_IGUALLAH = 1596,
    SPECIES_LIZAKBAR = 1597,
    SPECIES_AUDIEON = 1598,
    SPECIES_SQUIRRFAP = 1599,
    SPECIES_RODEBATION = 1600,
    SPECIES_CAROLINE = 1601,
    SPECIES_JONRUS = 1602,
    SPECIES_CUSTOM_END,
