...
enum __attribute__((packed)) Move
{
    ...
    MOVE_HOLY_DUTY = 850,
    MOVE_BOOM_BOX = 851,
    MOVE_TREBLE_BEAM = 852,
    MOVE_SYMPHONY = 853,
    MOVE_ECHOLOCATION = 854,
    MOVE_SQUEAK = 855,
    MOVE_VIBRATO = 856,
    MOVE_FORTISSIMO = 857,
    MOVE_BOOING = 858,
    MOVE_CONCERTO = 859,
    MOVE_DRUM_ROLL = 860,
    MOVE_SONIC_CHARGE = 861,
    MOVE_REQUIEM = 862,
    MOVE_GUN = 863,
    MOVE_SOUND_FANG = 864,
    MOVE_SUPER_BUG = 865,
    MOVE_BLJ = 866,
    MOVE_MORRIS_WORM = 867,
    MOVE_ION_SHOT = 868,
    MOVE_FL4M3THR0W3R = 869,
    MOVE_THUND3R = 870,
    MOVE_CORRUPTION = 871,
    MOVE_DOWNLOAD = 872,
    MOVE_KILO_BYTE = 873,
    MOVE_MEGA_BYTE = 874,
    MOVE_GIGA_BYTE = 875,
    MOVE_C_INJECTION = 876,
    MOVE_SELF_DOUBT = 877,
    MOVE_WALL_CLIP = 878,
    MOVE_TROJAN_HORSE = 879,
    MOVE_VIRUS_DRAIN = 880,
    MOVE_HACK = 881,
    MOVE_SPAM_ATTACK = 882,
    MOVE_POST_MEMES = 883,
    MOVE_WORLD_MINUS_ONE = 884,
    MOVE_IDENTITY_THEFT = 885,
    MOVE_DEATH_NOTE = 886,
    MOVE_LOVE_ARROW = 887,
    MOVE_MALWARE = 888,
    MOVE_COLD_HEART = 889,
    MOVE_FIRST_KISS = 890,
    MOVE_HEART_BLADE = 891,
    MOVE_LOVE_BEAM = 892,
    MOVE_CHILDS_PLAY = 893,
    MOVE_BURNING_PASSION = 894,
    MOVE_HEARTS_EYE = 895,
    MOVE_BREAK_UP = 896,
    MOVE_ROBLOX_BOY = 897,
    MOVE_ULTIMATE_DESIRE = 898,
    MOVE_TENDER_STRIKE = 899,
    MOVE_VALENTINE = 900,
    MOVE_INDOCTRINATE = 901,
    MOVE_HEART_EXCHANGE = 902,
    MOVE_MEGAHEART = 903,
    MOVE_LOVE_LETTER = 904,
    MOVE_LIGHT_BALL = 905,
    MOVE_LIGHT_SPEED = 906,
    MOVE_LIGHT_SABER = 907,
    MOVE_HAPPY_GLOW = 908,
    MOVE_SUN_SHINE = 909,
    MOVE_LASER_POINT = 910,
    MOVE_SHINING_LIGHT = 911,
    MOVE_LIGHT_ARROW = 912,
    MOVE_BRIGHT_IDEA = 913,
    MOVE_SHINE_THIEF = 914,
    MOVE_BULB_CHANGE = 915,
    MOVE_LIGHT_WHEEL = 916,
    MOVE_RAY_OF_LIGHT = 917,
    MOVE_LIGHT_WEIGHT = 918,
    MOVE_SHINE_HIT = 919,
    MOVE_BIBLE_SLAM = 920,
    MOVE_LIGHT_PULSE = 921,
    MOVE_LASER = 922,
    MOVE_BASS_DROP = 923,
    MOVES_COUNT_CUSTOM,
