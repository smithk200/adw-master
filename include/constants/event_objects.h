...
enum
{
    ...
    OBJ_EVENT_GFX_CUTTABLE_CHEESE,
    OBJ_EVENT_GFX_LEADER_JOE,
    OBJ_EVENT_GFX_LEADER_DONNA,
    OBJ_EVENT_GFX_LEADER_NED,
    OBJ_EVENT_GFX_LEADER_NATALIE,
    OBJ_EVENT_GFX_LEADER_JOHN,
    OBJ_EVENT_GFX_LEADER_CECI,
    OBJ_EVENT_GFX_LEADER_RAIHAN,
    OBJ_EVENT_GFX_YOUR_MOM,
    OBJ_EVENT_GFX_BEN_SHAPIRO,
    OBJ_EVENT_GFX_KAITILIN_BENNETT,
    OBJ_EVENT_GFX_STEVEN_CROWDER,
    OBJ_EVENT_GFX_JUMBO_GRUNT_M,
    OBJ_EVENT_GFX_JUMBO_GRUNT_F,
    OBJ_EVENT_GFX_ASS_GRUNT_M,
    OBJ_EVENT_GFX_ASS_GRUNT_F,
    OBJ_EVENT_GFX_HEYIMMIGHTY,
    OBJ_EVENT_GFX_GEORGE_FLOYD,
    OBJ_EVENT_GFX_HARPER_BLUE,
    OBJ_EVENT_GFX_AOC,
    OBJ_EVENT_GFX_CYRUS,
    OBJ_EVENT_GFX_MARS,
    ...
    OBJ_EVENT_GFX_SMALLANT,
    OBJ_EVENT_GFX_JAIDEN_ANIMATIONS,
    OBJ_EVENT_GFX_JOY,
    OBJ_EVENT_GFX_CHARLOTTE,
    OBJ_EVENT_GFX_SNOOP,
    OBJ_EVENT_GFX_BECKHAM,
    OBJ_EVENT_GFX_CHARLIE,
    OBJ_EVENT_GFX_ELSA,
    OBJ_EVENT_GFX_MARCUS,
    OBJ_EVENT_GFX_GODDARD,
    OBJ_EVENT_GFX_MARIO,
    OBJ_EVENT_GFX_BATMAN,
    OBJ_EVENT_GFX_WYATT,
    OBJ_EVENT_GFX_DARUDE,
    OBJ_EVENT_GFX_SELAH,
    OBJ_EVENT_GFX_BARBADOS_SLIM,
    OBJ_EVENT_GFX_LUIGI,
    OBJ_EVENT_GFX_JEFFERY,
    OBJ_EVENT_GFX_BENDER,
    OBJ_EVENT_GFX_BILL_NYE,
    OBJ_EVENT_GFX_TUMBLRITA,
    OBJ_EVENT_GFX_DYLAN_M,
    OBJ_EVENT_GFX_BLOSSOM,
    OBJ_EVENT_GFX_KARL_MARX,
    OBJ_EVENT_GFX_GOD,
    OBJ_EVENT_GFX_JESUS,
    OBJ_EVENT_GFX_LEELA,
    OBJ_EVENT_GFX_AMY,
    OBJ_EVENT_GFX_ZOIDBERG,
    OBJ_EVENT_GFX_FARNSWORTH,
    OBJ_EVENT_GFX_HERMES,
    OBJ_EVENT_GFX_BRITTANY,
    OBJ_EVENT_GFX_FRY,
    OBJ_EVENT_GFX_MATT_WALSH,
    OBJ_EVENT_GFX_SAVANNA,
    OBJ_EVENT_GFX_TEACHER_JOY,
    OBJ_EVENT_GFX_TEACHER_STEPHANIE,
    OBJ_EVENT_GFX_TEACHER_MELADEE,
    OBJ_EVENT_GFX_TEACHER_COLLEEN,
    OBJ_EVENT_GFX_BLOND_CHILD_F,
    OBJ_EVENT_GFX_BLONDCHILD_M,
    OBJ_EVENT_GFX_OFFICER,
    OBJ_EVENT_GFX_BROWNHAIREDCHILDM,
    OBJ_EVENT_GFX_BROWNHAIREDCHILDF,
    OBJ_EVENT_GFX_BLACKHAIREDCHILDM,
    OBJ_EVENT_GFX_BLACKHARIEDCHILDF,
    OBJ_EVENT_GFX_TARDIS,
    OBJ_EVENT_GFX_PROF_TWIG,
    NUM_OBJ_EVENT_GFX,
};
...
#define OBJ_EVENT_PAL_TAG_PROF_TWIG               0x1134
#define OBJ_EVENT_PAL_TAG_TARDIS                  0x1135
#define OBJ_EVENT_PAL_TAG_LEADER_JOE              0x1136
#define OBJ_EVENT_PAL_TAG_CYRUS                  0x1137
#define OBJ_EVENT_PAL_TAG_MARS                   0x1138
#define OBJ_EVENT_PAL_TAG_JUPITER                0x1139
#define OBJ_EVENT_PAL_TAG_SATURN                 0x113A
#define OBJ_EVENT_PAL_TAG_GALACTIC_GRUNT         0x113B
