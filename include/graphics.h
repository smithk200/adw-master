...
extern const u32 gItemIconPalette_GalarianStone[];
extern const u32 gItemIcon_PaldeanStone[];
extern const u32 gItemIconPalette_PaldeanStone[];
...
extern const u16 gHealthboxPlayerPal[];
extern const u16 gHealthbarPlayerPal[];
