...
static const u8 sText_Trainer1SentOutPkmnGalactic[] = _("Team Galactic Grunt sent out {B_OPPONENT_MON1_NAME}!");
static const u8 sText_Trainer1SentOutPkmnGalacticBoss[] = _("Galactic {B_TRAINER1_NAME_WITH_CLASS} sent out {B_OPPONENT_MON1_NAME}!");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNEVADEDATTACK]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s attack missed!"),
