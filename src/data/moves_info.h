...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_BASS_DROP] =
    {
        .name = COMPOUND_STRING("Bass Drop"),
        .description = COMPOUND_STRING(
            "The user DROPS IT HARD.\n"
    ...
    [MOVE_TRIGGER] =
    {
        .name = COMPOUND_STRING("Trigger"),
        .description = COMPOUND_STRING(
            "This psychic attack gets\n"
            "stronger if used in succession."),
        .power = 40,
        .effect = EFFECT_FURY_CUTTER,
        .type = TYPE_PSYCHIC,
        .accuracy = 100,
    ...
    [MOVE_BOOM_BOX] =
    {
        .name = COMPOUND_STRING("Boom Box"),
        .description = COMPOUND_STRING(
            "Punches with a fist using\n"
            "sonic vibrations. Can flinch."),
        .power = 65,
        .effect = EFFECT_HIT,
        .type = TYPE_SOUND,
        .accuracy = 95,
    ...
    [MOVE_TREBLE_BEAM] =
    {
        .name = COMPOUND_STRING("Treble Beam"),
        .description = COMPOUND_STRING(
            "Beams out a really high note.\n"
    ...
    [MOVE_SYMPHONY] = //reference "Symphony" song: https://www.youtube.com/watch?v=aatr_2MstrI
    {
        .name = COMPOUND_STRING("Symphony"),
        .description = COMPOUND_STRING(
            "Blasts everyone with a SYMPHONY.\n"
            "Attacks both targets in doubles."),
        .power = 120,
        .effect = EFFECT_HIT,
        .type = TYPE_SOUND,
        .accuracy = 90,
    ...
    [MOVE_ECHOLOCATION] =
    {
        ...
        .description = COMPOUND_STRING(
            "Uses echolocation to increase\n"
            "Speed and accuracy."),
        //.effect = EFFECT_SPEED_ACCURACY_UP,
    ...
    [MOVE_VIBRATO] =
    {
        .name = COMPOUND_STRING("Vibrato"),
        .description = COMPOUND_STRING(
            "High pitched sound that can\n"
            "reduce the target's Sp. Def."),
        .power = 40,
        .effect = EFFECT_HIT,
        .type = TYPE_SOUND,
        .accuracy = 100,
    ...
    [MOVE_FORTISSIMO] =
    {
        .name = COMPOUND_STRING("Fortissimo"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BOOING] =
    {
        .name = COMPOUND_STRING("Booing"),
        .description = COMPOUND_STRING(
            "Massive booing allows the player\n"
            "to switch without fail."),
        .effect = EFFECT_HIT_ESCAPE,
        .power = 65,
        .type = TYPE_SOUND,
        .accuracy = 95,
    ...
    [MOVE_CONCERTO] =
    {   
        .name = COMPOUND_STRING("Concerto"),
        .description = COMPOUND_STRING(
            "Makes target listen to a boring\n"
            "concert. Can lower their Sp. Def."),
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_SOUND,
        .accuracy = 100,
    ...
    [MOVE_DRUM_ROLL] =
    {
        .name = COMPOUND_STRING("Drum Roll"),
        .description = COMPOUND_STRING(
            "Attacks the foe by loud\n"
            "drums 2 to 5 times in a row."),
        .effect = EFFECT_HIT,
        .multiHit = TRUE,
        .power = 25,
        .type = TYPE_SOUND,
    ...
    [MOVE_SONIC_CHARGE] =
    {
        .name = COMPOUND_STRING("Sonic Charge"),
        .description = COMPOUND_STRING(
            "A full-body sound wave that\n"
            "may cause paralysis."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_SOUND,
    ...
    [MOVE_REQUIEM] =
    {
        ...
        .description = COMPOUND_STRING(
            "A powerful, soul-moving blast\n"
            "of sound. Can lower Speed."),
        .power = 160,
        .effect = EFFECT_HIT,
        .type = TYPE_SOUND,
        .accuracy = 60,
    ...
    [MOVE_SOUND_FANG] =
    {
        .name = COMPOUND_STRING("Sound Fang"),
        .description = COMPOUND_STRING(
            "Uses fangs of sound\n"
    ...
    [MOVE_SUPER_BUG] =
    {
        .name = COMPOUND_STRING("Super Bug"),
        .description = COMPOUND_STRING(
            "The most powerful bug move\n"
    ...
    [MOVE_BLJ] =
    {
        .name = COMPOUND_STRING("BLJ"),
        .description = COMPOUND_STRING(
            "Performs a Backwards Long Jump\n"
            "on the foe. WAHOOOO!"),
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_GLITCH,
    ...
    [MOVE_MORRIS_WORM] =
    {
        .name = COMPOUND_STRING("Morris Worm"),
        .description = COMPOUND_STRING(
            "Sends the Morris Worm on a\n"
            "foe. Go, Morris, go!"),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_GLITCH,
    ...
    [MOVE_ION_SHOT] =
    {
        .name = COMPOUND_STRING("Ion Shot"),
        .description = COMPOUND_STRING(
            "Uses an ion shot to attack\n"
            "the foe from afar."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_GLITCH,
	...
	[MOVE_FL4M3THR0W3R] =
    {
        .name = COMPOUND_STRING("Fl4m3thr0w3r"),
        .description = COMPOUND_STRING(
            "Uses an ion shot to attack\n"
            "the foe from afar."),
        .effect = EFFECT_HIT,
	...
	[MOVE_CORRUPTION] =
    {
        .name = COMPOUND_STRING("Corruption"),
        .description = COMPOUND_STRING(
            "Uses an ion shot to attack\n"
            "the foe from afar."),
        .effect = EFFECT_HIT,
	...
	[MOVE_KILO_BYTE] =
    {
        .name = COMPOUND_STRING("Kilo Byte"),
        .description = COMPOUND_STRING(
            "Kilo Byte. Get it? Haha.\n"
            "Kilo BITE."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_GLITCH,
	...
	[MOVE_MEGA_BYTE] =
    {
        .name = COMPOUND_STRING("Mega Byte"),
        .description = COMPOUND_STRING(
            "Mega Byte. Get it? Haha.\n"
            "Mega BITE."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_GLITCH,
	...
	[MOVE_GIGA_BYTE] =
    {
        .name = COMPOUND_STRING("Giga Byte"),
        .description = COMPOUND_STRING(
            "Giga Byte. Get it? Haha.\n"
            " Giga BITE."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_GLITCH,
	...
	[MOVE_C_INJECTION] =
    {
        .name = COMPOUND_STRING("C Injection"),
        .description = COMPOUND_STRING(
            "Injects the target with C code.\n"
            "Does more damage depending on weight."),
        .effect = EFFECT_LOW_KICK,
        .power = 1,
        .type = TYPE_GLITCH,
        .accuracy = 100,
    ...
    [MOVE_SELF_DOUBT] =
    {
        .name = COMPOUND_STRING("Self Doubt"),
        .description = COMPOUND_STRING(
            "Doubts the self.\n"
            "Lowers all stats by one stage."),
        .effect = EFFECT_LOW_KICK,
        .power = 1,
        .type = TYPE_BUG,
        .accuracy = 100,
	...
	[MOVE_WALL_CLIP] =
    {
        .name = COMPOUND_STRING("Wall Clip"),
        .description = COMPOUND_STRING(
            "Clips through the wall to\n"
            "sneak on the foe."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_GLITCH,
	...
	[MOVE_TROJAN_HORSE] =
    {
        .name = COMPOUND_STRING("Trojan Horse"),
        .description = COMPOUND_STRING(
            "Disguises itself as a real\n"
            "program in order to be run."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_GLITCH,
        .accuracy = 95,
	...
	[MOVE_VIRUS_DRAIN] =
    {
        .name = COMPOUND_STRING("Virus Drain"),
        .description = COMPOUND_STRING(
            "Uses a virus to drain the\n"
            "energy from the foe to the user."),
        .effect = EFFECT_ABSORB,
        .power = 70,
        .type = TYPE_GLITCH,
        .accuracy = 100,
	...
	[MOVE_HACK] =
    {
        .name = COMPOUND_STRING("Hack"),
        .description = COMPOUND_STRING(
            "Hacks' the foe's code."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_GLITCH,
        .accuracy = 100,
	...
	[MOVE_SPAM_ATTACK] =
    {
        .name = COMPOUND_STRING("Spam Attack"),
        .description = COMPOUND_STRING(
            "Spam attacks the foe\n"
            "2 to 5 times."),
        .effect = EFFECT_HIT,
        .multiHit = TRUE,
        .power = 20,
	...
	[MOVE_POST_MEMES] =
    {
        .name = COMPOUND_STRING("Post Memes"),
        .description = COMPOUND_STRING(
            "Posts memes. Confuses the user\n"
            "after 2 to 3 turns."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_GLITCH,
	...
	[MOVE_WORLD_MINUS_ONE] =
    {
        .name = COMPOUND_STRING("World -1"),
        .description = COMPOUND_STRING(
	...
	[MOVE_IDENTITY_THEFT] =
    {
        .name = COMPOUND_STRING("Identity Theft"),
        .description = COMPOUND_STRING(
            "Steals the foe's identity.\n"
            "Takes their item if it hits."),
        .effect = EFFECT_STEAL_ITEM,
        .power = 100,
        .type = TYPE_GLITCH,
        .accuracy = 50,
	...
	[MOVE_DEATH_NOTE] =
    {
        .name = COMPOUND_STRING("Death Note"),
        .description = COMPOUND_STRING(
            "Goes into the Shinigami realm the\n"
            "1st turn, then comes out in the 2nd."),
        .effect = EFFECT_SEMI_INVULNERABLE,
        .power = 120,
        .type = TYPE_GLITCH,
        .accuracy = 100,
	...
	[MOVE_LOVE_ARROW] =
    {
        .name = COMPOUND_STRING("Love Arrow"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_HEART,
    ...
    [MOVE_MALWARE] =
    {
        .name = COMPOUND_STRING("Malware"),
        .description = COMPOUND_STRING(
            "Infects the target with malware.\n"
            "May drop Sp. Def."),
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_GLITCH,
	...
	[MOVE_COLD_HEART] =
    {
        .name = COMPOUND_STRING("Cold Heart"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_FIRST_KISS] =
    {
        .name = COMPOUND_STRING("First Kiss"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_HEART_BLADE] =
    {
        .name = COMPOUND_STRING("Heart Blade"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_LOVE_BEAM] =
    {
        .name = COMPOUND_STRING("Love Beam"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_CHILDS_PLAY] =
    {
        .name = COMPOUND_STRING("Child's Play"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_ROBLOX_BOY] =
    {
        .name = COMPOUND_STRING("Roblox Boy)"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_ULTIMATE_DESIRE] =
    {
        .name = COMPOUND_STRING("Ultimate Desire"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_TENDER_STRIKE] =
    {
        .name = COMPOUND_STRING("Tender Strike"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_VALENTINE] =
    {
        .name = COMPOUND_STRING("Valentine"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_INDOCTRINATE] =
    {
        .name = COMPOUND_STRING("Indoctrinate"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_HEART_EXCHANGE] =
    {
        .name = COMPOUND_STRING("Heart Exchange"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        //.effect = EFFECT_HOLY_DUTY,
	...
	[MOVE_MEGAHEART] =
    {
        .name = COMPOUND_STRING("Megaheart"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_LOVE_LETTER] =
    {
        .name = COMPOUND_STRING("Love Letter"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_LIGHT_SABER] =
    {
        .name = COMPOUND_STRING("Light Saber"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_HAPPY_GLOW] =
    {
        .name = COMPOUND_STRING("Happy Glow"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_SUN_SHINE] =
    {
        .name = COMPOUND_STRING("Sun Shine"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_LASER_POINT] =
    {
        .name = COMPOUND_STRING("Laser Point"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_SHINING_LIGHT] =
    {
        .name = COMPOUND_STRING("Shining Light"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_LIGHT_ARROW] =
    {
        .name = COMPOUND_STRING("Light Arrow"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_BRIGHT_IDEA] =
    {
        .name = COMPOUND_STRING("Bright Idea"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_SHINE_THIEF] =
    {
        .name = COMPOUND_STRING("Shine Thief"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_BULB_CHANGE] =
    {
        .name = COMPOUND_STRING("Bulb Change"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_LIGHT_WHEEL] =
    {
        .name = COMPOUND_STRING("Light Wheel"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_RAY_OF_LIGHT] =
    {
        .name = COMPOUND_STRING("Ray of Light"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_LIGHT_WEIGHT] =
    {
        .name = COMPOUND_STRING("Light Weight"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_LOW_KICK,
	...
	[MOVE_SHINE_HIT] =
    {
        .name = COMPOUND_STRING("Shine Hit"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_BIBLE_SLAM] =
    {
        .name = COMPOUND_STRING("Bible Slam"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
	...
	[MOVE_LIGHT_PULSE] =
    {
        .name = COMPOUND_STRING("Light Pulse"),
        .description = COMPOUND_STRING(
            "This move still needs its\n"
            "description added."),
        .effect = EFFECT_HIT,
