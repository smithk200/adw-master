static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_OLDALE_TOWN - 1] = {MAP_GROUP(HAMMERSOCK), MAP_NUM(HAMMERSOCK), 20, 21},
    ...
    [HEAL_LOCATION_TWIGTON_CITY_PLAYERS_HOUSE2F - 1] = {MAP_GROUP(TWIGTON_CITY_PLAYERS_HOUSE2F), MAP_NUM(TWIGTON_CITY_PLAYERS_HOUSE2F), 2, 5},
    [HEAL_LOCATION_HAMMERSOCK - 1] = {MAP_GROUP(HAMMERSOCK), MAP_NUM(HAMMERSOCK), 20, 21},
    [HEAL_LOCATION_ELWOOD_CITY - 1] = {MAP_GROUP(ELWOOD_CITY), MAP_NUM(ELWOOD_CITY), 10, 28},
    [HEAL_LOCATION_ROUTE_4 - 1] = {MAP_GROUP(ROUTE4), MAP_NUM(ROUTE4), 6, 15},
    [HEAL_LOCATION_STONEVEIL_TOWN - 1] = {MAP_GROUP(STONEVEIL_TOWN), MAP_NUM(STONEVEIL_TOWN), 10, 10},
};
