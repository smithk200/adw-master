...
extern const struct BattleBackground gBattleEnvironmentInfo[];
...
static void LoadBattleBg(u8 battleBgType, enum BattleEnvironments battleEnvironment)
{
    ...
    case MAP_BATTLE_SCENE_NORMAL:
        LZDecompressVram(gBattleEnvironmentInfo[battleEnvironment].tileset, (void*)(BG_CHAR_ADDR(2)));
        LZDecompressVram(gBattleEnvironmentInfo[battleEnvironment].tilemap, (void*)(BG_SCREEN_ADDR(26)));
        LoadCompressedPalette(gBattleEnvironmentInfo[battleEnvironment].palette, 0x20, 0x60);
        break;
    case MAP_BATTLE_SCENE_GYM:
        ...
        LoadCompressedPalette(gBattleEnvironmentPalette_Building_2, 0x20, 0x60);
        break;
