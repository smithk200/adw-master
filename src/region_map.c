...
{
    [MAPSEC_TWIGTON_CITY] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(TWIGTON_CITY_PLAYERS_HOUSE2F), HEAL_LOCATION_TWIGTON_CITY_PLAYERS_HOUSE2F},
    [MAPSEC_HAMMERSOCK] = {MAP_GROUP(OLDALE_TOWN), MAP_NUM(OLDALE_TOWN), HEAL_LOCATION_OLDALE_TOWN},
    [MAPSEC_ELWOOD_CITY] = {MAP_GROUP(DEWFORD_TOWN), MAP_NUM(DEWFORD_TOWN), HEAL_LOCATION_DEWFORD_TOWN},
    [MAPSEC_WASHINGTON_CITY] = {MAP_GROUP(LAVARIDGE_TOWN), MAP_NUM(LAVARIDGE_TOWN), HEAL_LOCATION_LAVARIDGE_TOWN},
    [MAPSEC_STONEVEIL_TOWN] = {MAP_GROUP(FALLARBOR_TOWN), MAP_NUM(FALLARBOR_TOWN), HEAL_LOCATION_FALLARBOR_TOWN},
    [MAPSEC_TORCHWOOD_CITY] = {MAP_GROUP(VERDANTURF_TOWN), MAP_NUM(VERDANTURF_TOWN), HEAL_LOCATION_VERDANTURF_TOWN},
...
static void CreateFlyDestIcons(void)
{
    ...
    for (mapSecId = MAPSEC_TWIGTON_CITY; mapSecId <= MAPSEC_EVER_GRANDE_CITY; mapSecId++)
    {
