...
{
    [MAPSEC_TWIGTON_CITY] = {MAP_GROUP(MAP_LITTLEROOT_TOWN), MAP_NUM(MAP_TWIGTON_CITY_PLAYERS_HOUSE2F), HEAL_LOCATION_OLDALE_TOWN},
    [MAPSEC_HAMMERSOCK] = {MAP_GROUP(MAP_OLDALE_TOWN), MAP_NUM(MAP_OLDALE_TOWN), HEAL_LOCATION_OLDALE_TOWN},
    [MAPSEC_ELWOOD_CITY] = {MAP_GROUP(MAP_DEWFORD_TOWN), MAP_NUM(MAP_DEWFORD_TOWN), HEAL_LOCATION_DEWFORD_TOWN},
    [MAPSEC_WASHINGTON_CITY] = {MAP_GROUP(MAP_LAVARIDGE_TOWN), MAP_NUM(MAP_LAVARIDGE_TOWN), HEAL_LOCATION_LAVARIDGE_TOWN},
    [MAPSEC_STONEVEIL_TOWN] = {MAP_GROUP(MAP_FALLARBOR_TOWN), MAP_NUM(MAP_FALLARBOR_TOWN), HEAL_LOCATION_FALLARBOR_TOWN},
    [MAPSEC_TORCHWOOD_CITY] = {MAP_GROUP(MAP_VERDANTURF_TOWN), MAP_NUM(MAP_VERDANTURF_TOWN), HEAL_LOCATION_VERDANTURF_TOWN},
...
static u8 GetMapsecType(mapsec_u16_t mapSecId)
{
    ...
    case MAPSEC_TWIGTON_CITY:
        return FlagGet(FLAG_VISITED_TWIGTON_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_HAMMERSOCK:
        return FlagGet(FLAG_VISITED_HAMMERSOCK) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_ELWOOD_CITY:
        return FlagGet(FLAG_VISITED_ELWOOD_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_WASHINGTON_CITY:
        return FlagGet(FLAG_VISITED_WASHINGTON_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_STONEVEIL_TOWN:
        return FlagGet(FLAG_VISITED_STONEVEIL_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_TORCHWOOD_CITY:
...
{
    {
        ...
        .flag = FLAG_VISITED_TWIGTON_CITY,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_HAMMERSOCK,
        .flag = FLAG_VISITED_HAMMERSOCK,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_STONEVEIL_TOWN,
        .flag = FLAG_VISITED_STONEVEIL_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_HAMMERSOCK,
