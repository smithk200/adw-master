...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_DUSTY] = REMATCH(TRAINER_NONE, TRAINER_NONE, TRAINER_NONE, TRAINER_NONE, TRAINER_NONE, ROUTE111),
    ...
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_GABRIELLE_2, TRAINER_GABRIELLE_2, TRAINER_GABRIELLE_3, TRAINER_GABRIELLE_4, TRAINER_GABRIELLE_5, MT_PYRE_3F),
    ...
    [REMATCH_SAWYER] = REMATCH(TRAINER_WALLACE, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, MT_CHIMNEY),
...
static void CB2_EndTrainerBattle(void)
{
    ...
    else if (IsPlayerDefeated(gBattleOutcome) == TRUE)
    {
        if (InBattlePyramid() || InTrainerHillChallenge() || (!NoAliveMonsForPlayer()))
            SetMainCallback2(CB2_ReturnToFieldContinueScriptPlayMapMusic);
        else if ((TRAINER_BATTLE_PARAM.opponentA == TRAINER_BRITTANY_TWIGS_LAB_PLAYER_CHOSE_GRASSHOLE) || (TRAINER_BATTLE_PARAM.opponentA == TRAINER_BRITTANY_TWIGS_LAB_PLAYER_CHOSE_SQUIRTLE) || (TRAINER_BATTLE_PARAM.opponentA == TRAINER_BRITTANY_TWIGS_LAB_PLAYER_CHOSE_SCORBUNNY))
